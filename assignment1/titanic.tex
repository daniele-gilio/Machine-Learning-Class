...
\label{fig:cvssp}
\end{figure}
To further investigate this we plotted the \enquote{empirical} chance of survival, which is basically the relative frequency, against the classes we spotted. The graphs in Figure \ref{fig:emp} tell us that we might be on the right track.
\begin{figure}[!ht]
\centering
